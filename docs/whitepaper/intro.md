...
Furthemore, Redcurry is open-source, fully transparent, publicly auditable, permissionless, and on-chain. It is currently being implemented on EVM compatible blockchains. Redcurry is governed by the Currinomics Foundation, but will gradually evolve toward a DAO. [Read more about the product and technology here](/asset/technology/overview.md).
